...
import {
  FETCH_LEARNING_DAYS_START, FETCH_LEARNING_DAYS_FAIL, FETCH_LEARNING_DAYS_SUCCESS, START_LEARNING_DAY_FAIL, START_LEARNING_DAY_SUCCESS, START_LEARNING_DAY_START, START_LEARNING_DAY_SUSPEND, CANCEL_LEARNING_DAY_SUSPEND, CANCEL_LEARNING_DAY_START, CANCEL_LEARNING_DAY_SUCCESS, CANCEL_LEARNING_DAY_FAIL, UPDATE_LEARNING_DAY_START, UPDATE_LEARNING_DAY_FAIL, UPDATE_LEARNING_DAY_SUSPEND,
...
const learningDays = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_LEARNING_DAY_SUCCEEDED:
      return {
        ...state,
