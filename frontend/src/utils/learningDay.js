...
const getTeamLearningDaysFromDate = (date, teamLearningDays) => {
  return teamLearningDays.filter(day => areDatesEqual(fromISOStringToDate(day.date), date));
};

export {
  isSelfLearningDay, isTeamLearningDay, getSelfLearningDayFromDate, getTeamLearningDaysFromDate,
};
