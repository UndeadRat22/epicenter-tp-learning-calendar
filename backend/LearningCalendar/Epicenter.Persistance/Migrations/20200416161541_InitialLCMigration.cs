        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentTopicId = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    InvitationFromId = table.Column<string>(nullable: false),
                    InvitationTo = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invites_AspNetUsers_InvitationFromId",
                        column: x => x.InvitationFromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningDays_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "LearningDayTopics",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    LearningDayId = table.Column<Guid>(nullable: false),
                    TopicId = table.Column<Guid>(nullable: false),
                    ProgressStatus = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningDayTopics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearningDayTopics_LearningDays_LearningDayId",
                        column: x => x.LearningDayId,
                        principalTable: "LearningDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearningDayTopics_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invites_InvitationFromId",
                table: "Invites",
                column: "InvitationFromId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningDayTopics_LearningDayId",
                table: "LearningDayTopics",
                column: "LearningDayId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningDayTopics_TopicId",
                table: "LearningDayTopics",
                column: "TopicId");
